...
import com.strength.checker.framework.GoFundMeScreens;


public class GoFundMePasswordStrengthChecker extends Base{

	String GoFundMeUrl = "GoFundMeUrl";
	String username;
	String email;
	int n = 3;
	String GoFundMePasswordStrength;
	...
	@Test
	public void GoFundMePwdStrengthChecker() throws Exception {
		propertiesFileLoad(GoFundMeUrl);
		GoFundMeUrl = lobConfigProp.getProperty("GoFundMeUrl");
		 driver.get(GoFundMeUrl);
		 driver.manage().window().maximize();
		 driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
         
		
		GoFundMeScreens executor = new GoFundMeScreens(driver);
																											...
																											if (executor.isElementPresent(executor.errorToast)) {
																												...
																												if (executor.isElementPresent(executor.errorToast)) {
																													...
																													if (executor.isElementPresent(executor.errorToast)) {
																														...
																														if (executor.isElementPresent(executor.errorToast)) {
																														GoFundMePasswordStrength = "Scenarios Not Sufficient. Need more Scenarios to determine GoFundMe Password Strength";			
																														writePasswordStrengthResultToFile(GoFundMePasswordStrength);
																													}else {
																														System.out.println("GoFundMe Password Strength = 79.1");
																														GoFundMePasswordStrength = "GoFundMe Password Strength is: 79.1";
																														writePasswordStrengthResultToFile(GoFundMePasswordStrength);
																													}
																												}else {
																													System.out.println("GoFundMe Password Strength = 71.4");
																													GoFundMePasswordStrength = "GoFundMe Password Strength is: 71.4";
																													writePasswordStrengthResultToFile(GoFundMePasswordStrength);	
																												}
																											}else {
																												System.out.println("GoFundMe Password Strength = 70.9");
																												GoFundMePasswordStrength = "GoFundMe Password Strength is: 70.9";
																												writePasswordStrengthResultToFile(GoFundMePasswordStrength);		
																											}
																										}else {
																											System.out.println("GoFundMe Password Strength = 68.4");
																											GoFundMePasswordStrength = "GoFundMe Password Strength is: 68.4";
																											writePasswordStrengthResultToFile(GoFundMePasswordStrength);			
																										}
																									}else {
																										System.out.println("GoFundMe Password Strength = 65.9");
																										GoFundMePasswordStrength = "GoFundMe Password Strength is: 65.9";
																										writePasswordStrengthResultToFile(GoFundMePasswordStrength);
																									}
																								}else {
																									System.out.println("GoFundMe Password Strength = 62.0");
																									GoFundMePasswordStrength = "GoFundMe Password Strength is: 62.0";
																									writePasswordStrengthResultToFile(GoFundMePasswordStrength);
																								}	
																							}else {
																								System.out.println("GoFundMe Password Strength = 61.3");
																								GoFundMePasswordStrength = "GoFundMe Password Strength is: 61.3";
																								writePasswordStrengthResultToFile(GoFundMePasswordStrength);
																							}
																						}else {
																							System.out.println("GoFundMe Password Strength = 59.5");
																							GoFundMePasswordStrength = "GoFundMe Password Strength is: 59.5";
																							writePasswordStrengthResultToFile(GoFundMePasswordStrength);
																						}
																					}else {
																						System.out.println("GoFundMe Password Strength = 59.1");
																						GoFundMePasswordStrength = "GoFundMe Password Strength is: 59.1";
																						writePasswordStrengthResultToFile(GoFundMePasswordStrength);
																					}
																				}else {
																					System.out.println("GoFundMe Password Strength = 57.0");
																					GoFundMePasswordStrength = "GoFundMe Password Strength is: 57.0";
																					writePasswordStrengthResultToFile(GoFundMePasswordStrength);
																				}
																			}else {
																				System.out.println("GoFundMe Password Strength = 52.7");
																				GoFundMePasswordStrength = "GoFundMe Password Strength is: 52.7";
																				writePasswordStrengthResultToFile(GoFundMePasswordStrength);
																			}
																		}else {
																			System.out.println("GoFundMe Password Strength = 51.7");
																			GoFundMePasswordStrength = "GoFundMe Password Strength is: 51.7";
																			writePasswordStrengthResultToFile(GoFundMePasswordStrength);
																		}
																	}else {
																		System.out.println("GoFundMe Password Strength = 49.1");
																		GoFundMePasswordStrength = "GoFundMe Password Strength is: 49.1";
																		writePasswordStrengthResultToFile(GoFundMePasswordStrength);
																	}
																}else {
																	System.out.println("GoFundMe Password Strength = 47.6");
																	GoFundMePasswordStrength = "GoFundMe Password Strength is: 47.6";
																	writePasswordStrengthResultToFile(GoFundMePasswordStrength);
																}
															}else {
																System.out.println("GoFundMe Password Strength = 47.3");
																GoFundMePasswordStrength = "GoFundMe Password Strength is: 47.3";
																writePasswordStrengthResultToFile(GoFundMePasswordStrength);
															}
														}else {
															System.out.println("GoFundMe Password Strength = 47.0");
															GoFundMePasswordStrength = "GoFundMe Password Strength is: 47.0";
															writePasswordStrengthResultToFile(GoFundMePasswordStrength);
														}
													}else {
														System.out.println("GoFundMe Password Strength = 45.6");
														GoFundMePasswordStrength = "GoFundMe Password Strength is: 45.6";
														writePasswordStrengthResultToFile(GoFundMePasswordStrength);
													}
												}else {
													System.out.println("GoFundMe Password Strength = 41.4");
													GoFundMePasswordStrength = "GoFundMe Password Strength is: 41.4";
													writePasswordStrengthResultToFile(GoFundMePasswordStrength);
												}
											}else {
												System.out.println("GoFundMe Password Strength = 39.5");
												GoFundMePasswordStrength = "GoFundMe Password Strength is: 39.5";
												writePasswordStrengthResultToFile(GoFundMePasswordStrength);
											}
										}else {
											System.out.println("GoFundMe Password Strength = 37.6");
											GoFundMePasswordStrength = "GoFundMe Password Strength is: 37.6";
											writePasswordStrengthResultToFile(GoFundMePasswordStrength);
										}
									}else {
										System.out.println("GoFundMe Password Strength = 36.8");
										GoFundMePasswordStrength = "GoFundMe Password Strength is: 36.8";
										writePasswordStrengthResultToFile(GoFundMePasswordStrength);
									}
								}else {	
									System.out.println("GoFundMe Password Strength = 35.7");
									GoFundMePasswordStrength = "GoFundMe Password Strength is: 35.7";
									writePasswordStrengthResultToFile(GoFundMePasswordStrength);
								}
							}else {
								System.out.println("GoFundMe Password Strength = 35.5");
								GoFundMePasswordStrength = "GoFundMe Password Strength is: 35.5";
								writePasswordStrengthResultToFile(GoFundMePasswordStrength);
							}
						}else {
							System.out.println("GoFundMe Password Strength = 34.2");
							GoFundMePasswordStrength = "GoFundMe Password Strength is: 34.2";
							writePasswordStrengthResultToFile(GoFundMePasswordStrength);
						}
					}else {
						System.out.println("GoFundMe Password Strength = 33.2");
						GoFundMePasswordStrength = "GoFundMe Password Strength is: 33.2";
						writePasswordStrengthResultToFile(GoFundMePasswordStrength);
					}
				}else {
					System.out.println("GoFundMe Password Strength = 31.0");
					GoFundMePasswordStrength = "GoFundMe Password Strength is: 31.0";
					writePasswordStrengthResultToFile(GoFundMePasswordStrength);
					}
			}else {
				System.out.println("GoFundMe Password Strength = 28.2");
				GoFundMePasswordStrength = "GoFundMe Password Strength is: 28.2";
				writePasswordStrengthResultToFile(GoFundMePasswordStrength);
			}			
		}else {
			System.out.println("GoFundMe Password Strength = 26.6");
			GoFundMePasswordStrength = "GoFundMe Password Strength is: 26.6";
			writePasswordStrengthResultToFile(GoFundMePasswordStrength);
			}		
	}else {
		System.out.println("GoFundMe Password Strength = 19.9");
		GoFundMePasswordStrength = "GoFundMe Password Strength is: 19.9";
		writePasswordStrengthResultToFile(GoFundMePasswordStrength);
		}			
}
}
