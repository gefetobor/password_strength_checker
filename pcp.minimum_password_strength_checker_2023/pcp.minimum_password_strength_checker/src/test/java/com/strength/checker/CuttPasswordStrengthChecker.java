...
import com.strength.checker.framework.CuttScreens;


public class CuttPasswordStrengthChecker extends Base{

	String CuttUrl = "CuttUrl";
	String username;
	String email;
	String dob = "26/04/1992";
	int n = 3;
	String CuttPasswordStrength;
	...
	@Test
	public void CuttPwdStrengthChecker() throws Exception {
		propertiesFileLoad(CuttUrl);
		CuttUrl = lobConfigProp.getProperty("CuttUrl");
		...
		CuttScreens executor = new CuttScreens(driver);
		...
		Thread.sleep(2000);
		executor.clickOnTermsOne();
		Thread.sleep(3000);
		executor.clickOnTermsTwo();
		Thread.sleep(3000);
																															...
																															if (executor.isElementPresent(executor.errorToast)) {
																																...
																																if (executor.isElementPresent(executor.errorToast)) {
																																	...
																																	if (executor.isElementPresent(executor.errorToast)) {
																																		...
																																		if (executor.isElementPresent(executor.errorToast)) {
																																		CuttPasswordStrength = "Scenarios Not Sufficient. Need more Scenarios to determine Cutt Password Strength";			
																																		writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
																																			}else {
																																		System.out.println("Cutt Password Strength = 79.1");
																																		CuttPasswordStrength = "Cutt Password Strength is: 79.1";
																																		writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
																																	}
																																}else {
																																	System.out.println("Cutt Password Strength = 71.4");
																																	CuttPasswordStrength = "Cutt Password Strength is: 71.4";
																																	writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
																																}
																															}else {
																																System.out.println("Cutt Password Strength = 70.9");
																																CuttPasswordStrength = "Cutt Password Strength is: 70.9";
																																writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
																															}
																														}else {
																															System.out.println("Cutt Password Strength = 68.4");
																															CuttPasswordStrength = "Cutt Password Strength is: 68.4";
																															writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
																														}
																													}else {
																														System.out.println("Cutt Password Strength = 65.9");
																														CuttPasswordStrength = "Cutt Password Strength is: 65.9";
																														writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
																													}
																												}else {
																													System.out.println("Cutt Password Strength = 65.5");
																													CuttPasswordStrength = "Cutt Password Strength is: 65.5";
																													writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);	
																												}
																											}else {
																												System.out.println("Cutt Password Strength = 62.0");
																												CuttPasswordStrength = "Cutt Password Strength is: 62.0";
																												writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);		
																											}
																										}else {
																											System.out.println("Cutt Password Strength = 61.3");
																											CuttPasswordStrength = "Cutt Password Strength is: 61.3";
																											writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);			
																										}
																									}else {
																										System.out.println("Cutt Password Strength = 59.5");
																										CuttPasswordStrength = "Cutt Password Strength is: 59.5";
																										writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
																									}
																								}else {
																									System.out.println("Cutt Password Strength = 59.1");
																									CuttPasswordStrength = "Cutt Password Strength is: 59.1";
																									writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
																									
																								}	
																							}else {
																								System.out.println("Cutt Password Strength = 57.0");
																								CuttPasswordStrength = "Cutt Password Strength is: 57.0";
																								writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
																							}
																						}else {
																							System.out.println("Cutt Password Strength = 54.6");
																							CuttPasswordStrength = "Cutt Password Strength is: 54.6";
																							writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
																						}
																					}else {
																						System.out.println("Cutt Password Strength = 52.7");
																						CuttPasswordStrength = "Cutt Password Strength is: 52.7";
																						writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
																					}
																				}else {
																					System.out.println("Cutt Password Strength = 51.7");
																					CuttPasswordStrength = "Cutt Password Strength is: 51.7";
																					writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
																				}
																			}else {
																				System.out.println("Cutt Password Strength = 49.1");
																				CuttPasswordStrength = "Cutt Password Strength is: 49.1";
																				writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
																			}
																		}else {
																			System.out.println("Cutt Password Strength = 47.6");
																			CuttPasswordStrength = "Cutt Password Strength is: 47.6";
																			writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
																		}
																	}else {
																		System.out.println("Cutt Password Strength = 47.3");
																		CuttPasswordStrength = "Cutt Password Strength is: 47.3";
																		writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
																	}
																}else {
																	System.out.println("Cutt Password Strength = 47.0");
																	CuttPasswordStrength = "Cutt Password Strength is: 47.0";
																	writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
																}
															}else {
																System.out.println("Cutt Password Strength = 45.6");
																CuttPasswordStrength = "Cutt Password Strength is: 45.6";
																writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
															}
														}else {
															System.out.println("Cutt Password Strength = 43.7");
															CuttPasswordStrength = "Cutt Password Strength is: 43.7";
															writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
														}
													}else {
														System.out.println("Cutt Password Strength = 41.4");
														CuttPasswordStrength = "Cutt Password Strength is: 41.4";
														writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
													}
												}else {
													System.out.println("Cutt Password Strength = 39.5");
													CuttPasswordStrength = "Cutt Password Strength is: 39.5";
													writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
												}
											}else {
												System.out.println("Cutt Password Strength = 37.6");
												CuttPasswordStrength = "Cutt Password Strength is: 37.6";
												writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
											}
										}else {
											System.out.println("Cutt Password Strength = 36.8");
											CuttPasswordStrength = "Cutt Password Strength is: 36.8";
											writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
										}
									}else {
										System.out.println("Cutt Password Strength = 35.7");
										CuttPasswordStrength = "Cutt Password Strength is: 35.7";
										writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
									}
								}else {	
									System.out.println("Cutt Password Strength = 35.5");
									CuttPasswordStrength = "Cutt Password Strength is: 35.5";
									writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
								}
							}else {
								System.out.println("Cutt Password Strength = 34.2");
								CuttPasswordStrength = "Cutt Password Strength is: 34.2";
								writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
							}
						}else {
							System.out.println("Cutt Password Strength = 33.2");
							CuttPasswordStrength = "Cutt Password Strength is: 33.2";
							writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
						}
					}else {
						System.out.println("Cutt Password Strength = 32.8");
						CuttPasswordStrength = "Cutt Password Strength is: 32.8";
						writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
					}
				}else {
					System.out.println("Cutt Password Strength = 31.0");
					CuttPasswordStrength = "Cutt Password Strength is: 31.0";
					writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
					}
			}else {
				System.out.println("Cutt Password Strength = 28.2");
				CuttPasswordStrength = "Cutt Password Strength is: 28.2";
				writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
			}			
		}else {
			System.out.println("Cutt Password Strength = 26.6");
			CuttPasswordStrength = "Cutt Password Strength is: 26.6";
			writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
			}		
	}else {
		System.out.println("Cutt Password Strength = 19.9");
		CuttPasswordStrength = "Cutt Password Strength is: 19.9";
		writePasswordStrengthResultToFile(CuttPasswordStrength); writePasswordStrengthResultToFile("Account created on Cutt is : " + email);
		}			
}
}
