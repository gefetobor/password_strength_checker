...
import com.strength.checker.framework.BandcampScreens;


public class BandcampPasswordStrengthChecker extends Base{

	String BandcampUrl = "BandcampUrl";
	String username;
	String email;
	String dob = "26/04/1992";
	int n = 3;
	String BandcampPasswordStrength;
	...
	@Test
	public void BandcampPwdStrengthChecker() throws Exception {
		propertiesFileLoad(BandcampUrl);
		BandcampUrl = lobConfigProp.getProperty("BandcampUrl");
		
		 driver.get(BandcampUrl);
		 driver.manage().window().maximize();
		 driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
         
		
		BandcampScreens executor = new BandcampScreens(driver);
		...
		if (executor.isElementPresent(executor.errorToast)) {
			...
			WebElement pwd = driver.findElement(By.xpath("//input[@id='password-input']"));
																															...
																															if (executor.isElementPresent(executor.errorToast)) {
																																...
																																if (executor.isElementPresent(executor.errorToast)) {
																																	...
																																	if (executor.isElementPresent(executor.errorToast)) {
																																		...
																																		if (executor.isElementPresent(executor.errorToast)) {
																																		BandcampPasswordStrength = "Scenarios Not Sufficient. Need more Scenarios to determine Bandcamp Password Strength";			
																																		writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
																																			}else {
																																		System.out.println("Bandcamp Password Strength = 79.1");
																																		BandcampPasswordStrength = "Bandcamp Password Strength is: 79.1";
																																		writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
																																	}
																																}else {
																																	System.out.println("Bandcamp Password Strength = 71.4");
																																	BandcampPasswordStrength = "Bandcamp Password Strength is: 71.4";
																																	writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
																																}
																															}else {
																																System.out.println("Bandcamp Password Strength = 70.9");
																																BandcampPasswordStrength = "Bandcamp Password Strength is: 70.9";
																																writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
																															}
																														}else {
																															System.out.println("Bandcamp Password Strength = 68.4");
																															BandcampPasswordStrength = "Bandcamp Password Strength is: 68.4";
																															writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
																														}
																													}else {
																														System.out.println("Bandcamp Password Strength = 65.9");
																														BandcampPasswordStrength = "Bandcamp Password Strength is: 65.9";
																														writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
																													}
																												}else {
																													System.out.println("Bandcamp Password Strength = 65.5");
																													BandcampPasswordStrength = "Bandcamp Password Strength is: 65.5";
																													writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);	
																												}
																											}else {
																												System.out.println("Bandcamp Password Strength = 62.0");
																												BandcampPasswordStrength = "Bandcamp Password Strength is: 62.0";
																												writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);		
																											}
																										}else {
																											System.out.println("Bandcamp Password Strength = 61.3");
																											BandcampPasswordStrength = "Bandcamp Password Strength is: 61.3";
																											writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);			
																										}
																									}else {
																										System.out.println("Bandcamp Password Strength = 59.5");
																										BandcampPasswordStrength = "Bandcamp Password Strength is: 59.5";
																										writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
																									}
																								}else {
																									System.out.println("Bandcamp Password Strength = 59.1");
																									BandcampPasswordStrength = "Bandcamp Password Strength is: 59.1";
																									writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
																									
																								}	
																							}else {
																								System.out.println("Bandcamp Password Strength = 57.0");
																								BandcampPasswordStrength = "Bandcamp Password Strength is: 57.0";
																								writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
																							}
																						}else {
																							System.out.println("Bandcamp Password Strength = 54.6");
																							BandcampPasswordStrength = "Bandcamp Password Strength is: 54.6";
																							writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
																						}
																					}else {
																						System.out.println("Bandcamp Password Strength = 52.7");
																						BandcampPasswordStrength = "Bandcamp Password Strength is: 52.7";
																						writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
																					}
																				}else {
																					System.out.println("Bandcamp Password Strength = 51.7");
																					BandcampPasswordStrength = "Bandcamp Password Strength is: 51.7";
																					writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
																				}
																			}else {
																				System.out.println("Bandcamp Password Strength = 49.1");
																				BandcampPasswordStrength = "Bandcamp Password Strength is: 49.1";
																				writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
																			}
																		}else {
																			System.out.println("Bandcamp Password Strength = 47.6");
																			BandcampPasswordStrength = "Bandcamp Password Strength is: 47.6";
																			writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
																		}
																	}else {
																		System.out.println("Bandcamp Password Strength = 47.3");
																		BandcampPasswordStrength = "Bandcamp Password Strength is: 47.3";
																		writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
																	}
																}else {
																	System.out.println("Bandcamp Password Strength = 47.0");
																	BandcampPasswordStrength = "Bandcamp Password Strength is: 47.0";
																	writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
																}
															}else {
																System.out.println("Bandcamp Password Strength = 45.6");
																BandcampPasswordStrength = "Bandcamp Password Strength is: 45.6";
																writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
															}
														}else {
															System.out.println("Bandcamp Password Strength = 43.7");
															BandcampPasswordStrength = "Bandcamp Password Strength is: 43.7";
															writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
														}
													}else {
														System.out.println("Bandcamp Password Strength = 41.4");
														BandcampPasswordStrength = "Bandcamp Password Strength is: 41.4";
														writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
													}
												}else {
													System.out.println("Bandcamp Password Strength = 39.5");
													BandcampPasswordStrength = "Bandcamp Password Strength is: 39.5";
													writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
												}
											}else {
												System.out.println("Bandcamp Password Strength = 37.6");
												BandcampPasswordStrength = "Bandcamp Password Strength is: 37.6";
												writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
											}
										}else {
											System.out.println("Bandcamp Password Strength = 36.8");
											BandcampPasswordStrength = "Bandcamp Password Strength is: 36.8";
											writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
										}
									}else {
										System.out.println("Bandcamp Password Strength = 35.7");
										BandcampPasswordStrength = "Bandcamp Password Strength is: 35.7";
										writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
									}
								}else {	
									System.out.println("Bandcamp Password Strength = 35.5");
									BandcampPasswordStrength = "Bandcamp Password Strength is: 35.5";
									writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
								}
							}else {
								System.out.println("Bandcamp Password Strength = 34.2");
								BandcampPasswordStrength = "Bandcamp Password Strength is: 34.2";
								writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
							}
						}else {
							System.out.println("Bandcamp Password Strength = 33.2");
							BandcampPasswordStrength = "Bandcamp Password Strength is: 33.2";
							writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
						}
					}else {
						System.out.println("Bandcamp Password Strength = 32.8");
						BandcampPasswordStrength = "Bandcamp Password Strength is: 32.8";
						writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
					}
				}else {
					System.out.println("Bandcamp Password Strength = 31.0");
					BandcampPasswordStrength = "Bandcamp Password Strength is: 31.0";
					writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
					}
			}else {
				System.out.println("Bandcamp Password Strength = 28.2");
				BandcampPasswordStrength = "Bandcamp Password Strength is: 28.2";
				writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
			}			
		}else {
			System.out.println("Bandcamp Password Strength = 26.6");
			BandcampPasswordStrength = "Bandcamp Password Strength is: 26.6";
			writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
			}		
	}else {
		System.out.println("Bandcamp Password Strength = 19.9");
		BandcampPasswordStrength = "Bandcamp Password Strength is: 19.9";
		writePasswordStrengthResultToFile(BandcampPasswordStrength); writePasswordStrengthResultToFile("Account created on Bandcamp is : " + email);
		}			
}
}
