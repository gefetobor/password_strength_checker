...
import com.strength.checker.framework.GloboScreens;


public class GloboPasswordStrengthChecker extends Base{

	String GloboUrl = "GloboUrl";
	String username;
	String email;
	int n = 3;
	String GloboPasswordStrength;
	...
	@Test
	public void GloboPwdStrengthChecker() throws Exception {
		propertiesFileLoad(GloboUrl);
		GloboUrl = lobConfigProp.getProperty("GloboUrl");
		 driver.get(GloboUrl);
		 driver.manage().window().maximize();
		 driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
         
		
		GloboScreens executor = new GloboScreens(driver);
		...
		if (executor.isElementPresent(executor.errorToast)) {
			...
			WebElement pwd = driver.findElement(By.xpath("//input[@id='senha']"));
																											...
																											if (executor.isElementPresent(executor.errorToast)) {
																												...
																												if (executor.isElementPresent(executor.errorToast)) {
																													...
																													if (executor.isElementPresent(executor.errorToast)) {
																														...
																														if (executor.isElementPresent(executor.errorToast)) {
																														GloboPasswordStrength = "Scenarios Not Sufficient. Need more Scenarios to determine Globo Password Strength";			
																														writePasswordStrengthResultToFile(GloboPasswordStrength);
																													}else {
																														System.out.println("Globo Password Strength = 79.1");
																														GloboPasswordStrength = "Globo Password Strength is: 79.1";
																														writePasswordStrengthResultToFile(GloboPasswordStrength);
																													}
																												}else {
																													System.out.println("Globo Password Strength = 71.4");
																													GloboPasswordStrength = "Globo Password Strength is: 71.4";
																													writePasswordStrengthResultToFile(GloboPasswordStrength);	
																												}
																											}else {
																												System.out.println("Globo Password Strength = 70.9");
																												GloboPasswordStrength = "Globo Password Strength is: 70.9";
																												writePasswordStrengthResultToFile(GloboPasswordStrength);		
																											}
																										}else {
																											System.out.println("Globo Password Strength = 68.4");
																											GloboPasswordStrength = "Globo Password Strength is: 68.4";
																											writePasswordStrengthResultToFile(GloboPasswordStrength);			
																										}
																									}else {
																										System.out.println("Globo Password Strength = 65.9");
																										GloboPasswordStrength = "Globo Password Strength is: 65.9";
																										writePasswordStrengthResultToFile(GloboPasswordStrength);
																									}
																								}else {
																									System.out.println("Globo Password Strength = 62.0");
																									GloboPasswordStrength = "Globo Password Strength is: 62.0";
																									writePasswordStrengthResultToFile(GloboPasswordStrength);
																								}	
																							}else {
																								System.out.println("Globo Password Strength = 61.3");
																								GloboPasswordStrength = "Globo Password Strength is: 61.3";
																								writePasswordStrengthResultToFile(GloboPasswordStrength);
																							}
																						}else {
																							System.out.println("Globo Password Strength = 59.5");
																							GloboPasswordStrength = "Globo Password Strength is: 59.5";
																							writePasswordStrengthResultToFile(GloboPasswordStrength);
																						}
																					}else {
																						System.out.println("Globo Password Strength = 59.1");
																						GloboPasswordStrength = "Globo Password Strength is: 59.1";
																						writePasswordStrengthResultToFile(GloboPasswordStrength);
																					}
																				}else {
																					System.out.println("Globo Password Strength = 57.0");
																					GloboPasswordStrength = "Globo Password Strength is: 57.0";
																					writePasswordStrengthResultToFile(GloboPasswordStrength);
																				}
																			}else {
																				System.out.println("Globo Password Strength = 52.7");
																				GloboPasswordStrength = "Globo Password Strength is: 52.7";
																				writePasswordStrengthResultToFile(GloboPasswordStrength);
																			}
																		}else {
																			System.out.println("Globo Password Strength = 51.7");
																			GloboPasswordStrength = "Globo Password Strength is: 51.7";
																			writePasswordStrengthResultToFile(GloboPasswordStrength);
																		}
																	}else {
																		System.out.println("Globo Password Strength = 49.1");
																		GloboPasswordStrength = "Globo Password Strength is: 49.1";
																		writePasswordStrengthResultToFile(GloboPasswordStrength);
																	}
																}else {
																	System.out.println("Globo Password Strength = 47.6");
																	GloboPasswordStrength = "Globo Password Strength is: 47.6";
																	writePasswordStrengthResultToFile(GloboPasswordStrength);
																}
															}else {
																System.out.println("Globo Password Strength = 47.3");
																GloboPasswordStrength = "Globo Password Strength is: 47.3";
																writePasswordStrengthResultToFile(GloboPasswordStrength);
															}
														}else {
															System.out.println("Globo Password Strength = 47.0");
															GloboPasswordStrength = "Globo Password Strength is: 47.0";
															writePasswordStrengthResultToFile(GloboPasswordStrength);
														}
													}else {
														System.out.println("Globo Password Strength = 45.6");
														GloboPasswordStrength = "Globo Password Strength is: 45.6";
														writePasswordStrengthResultToFile(GloboPasswordStrength);
													}
												}else {
													System.out.println("Globo Password Strength = 41.4");
													GloboPasswordStrength = "Globo Password Strength is: 41.4";
													writePasswordStrengthResultToFile(GloboPasswordStrength);
												}
											}else {
												System.out.println("Globo Password Strength = 39.5");
												GloboPasswordStrength = "Globo Password Strength is: 39.5";
												writePasswordStrengthResultToFile(GloboPasswordStrength);
											}
										}else {
											System.out.println("Globo Password Strength = 37.6");
											GloboPasswordStrength = "Globo Password Strength is: 37.6";
											writePasswordStrengthResultToFile(GloboPasswordStrength);
										}
									}else {
										System.out.println("Globo Password Strength = 36.8");
										GloboPasswordStrength = "Globo Password Strength is: 36.8";
										writePasswordStrengthResultToFile(GloboPasswordStrength);
									}
								}else {	
									System.out.println("Globo Password Strength = 35.7");
									GloboPasswordStrength = "Globo Password Strength is: 35.7";
									writePasswordStrengthResultToFile(GloboPasswordStrength);
								}
							}else {
								System.out.println("Globo Password Strength = 35.5");
								GloboPasswordStrength = "Globo Password Strength is: 35.5";
								writePasswordStrengthResultToFile(GloboPasswordStrength);
							}
						}else {
							System.out.println("Globo Password Strength = 34.2");
							GloboPasswordStrength = "Globo Password Strength is: 34.2";
							writePasswordStrengthResultToFile(GloboPasswordStrength);
						}
					}else {
						System.out.println("Globo Password Strength = 33.2");
						GloboPasswordStrength = "Globo Password Strength is: 33.2";
						writePasswordStrengthResultToFile(GloboPasswordStrength);
					}
				}else {
					System.out.println("Globo Password Strength = 31.0");
					GloboPasswordStrength = "Globo Password Strength is: 31.0";
					writePasswordStrengthResultToFile(GloboPasswordStrength);
					}
			}else {
				System.out.println("Globo Password Strength = 28.2");
				GloboPasswordStrength = "Globo Password Strength is: 28.2";
				writePasswordStrengthResultToFile(GloboPasswordStrength);
			}			
		}else {
			System.out.println("Globo Password Strength = 26.6");
			GloboPasswordStrength = "Globo Password Strength is: 26.6";
			writePasswordStrengthResultToFile(GloboPasswordStrength);
			}		
	}else {
		System.out.println("Globo Password Strength = 19.9");
		GloboPasswordStrength = "Globo Password Strength is: 19.9";
		writePasswordStrengthResultToFile(GloboPasswordStrength);
		}			
}
}
