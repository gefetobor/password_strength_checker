...
import com.strength.checker.framework.DeezerScreens;


public class DeezerPasswordStrengthChecker extends Base{

	String DeezerUrl = "DeezerUrl";
	String username;
	String email;
	int n = 3;
	String DeezerPasswordStrength;
	...
	@Test
	public void DeezerPwdStrengthChecker() throws Exception {
		propertiesFileLoad(DeezerUrl);
		DeezerUrl = lobConfigProp.getProperty("DeezerUrl");
		 driver.get(DeezerUrl);
		 driver.manage().window().maximize();
		 driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
         
		
		DeezerScreens executor = new DeezerScreens(driver);
																											...
																											if (executor.isElementPresent(executor.errorToast)) {
																												...
																												if (executor.isElementPresent(executor.errorToast)) {
																													...
																													if (executor.isElementPresent(executor.errorToast)) {
																														...
																														if (executor.isElementPresent(executor.errorToast)) {
																														DeezerPasswordStrength = "Scenarios Not Sufficient. Need more Scenarios to determine Deezer Password Strength";			
																														writePasswordStrengthResultToFile(DeezerPasswordStrength);
																													}else {
																														System.out.println("Deezer Password Strength = 79.1");
																														DeezerPasswordStrength = "Deezer Password Strength is: 79.1";
																														writePasswordStrengthResultToFile(DeezerPasswordStrength);
																													}
																												}else {
																													System.out.println("Deezer Password Strength = 71.4");
																													DeezerPasswordStrength = "Deezer Password Strength is: 71.4";
																													writePasswordStrengthResultToFile(DeezerPasswordStrength);	
																												}
																											}else {
																												System.out.println("Deezer Password Strength = 70.9");
																												DeezerPasswordStrength = "Deezer Password Strength is: 70.9";
																												writePasswordStrengthResultToFile(DeezerPasswordStrength);		
																											}
																										}else {
																											System.out.println("Deezer Password Strength = 68.4");
																											DeezerPasswordStrength = "Deezer Password Strength is: 68.4";
																											writePasswordStrengthResultToFile(DeezerPasswordStrength);			
																										}
																									}else {
																										System.out.println("Deezer Password Strength = 65.9");
																										DeezerPasswordStrength = "Deezer Password Strength is: 65.9";
																										writePasswordStrengthResultToFile(DeezerPasswordStrength);
																									}
																								}else {
																									System.out.println("Deezer Password Strength = 62.0");
																									DeezerPasswordStrength = "Deezer Password Strength is: 62.0";
																									writePasswordStrengthResultToFile(DeezerPasswordStrength);
																								}	
																							}else {
																								System.out.println("Deezer Password Strength = 61.3");
																								DeezerPasswordStrength = "Deezer Password Strength is: 61.3";
																								writePasswordStrengthResultToFile(DeezerPasswordStrength);
																							}
																						}else {
																							System.out.println("Deezer Password Strength = 59.5");
																							DeezerPasswordStrength = "Deezer Password Strength is: 59.5";
																							writePasswordStrengthResultToFile(DeezerPasswordStrength);
																						}
																					}else {
																						System.out.println("Deezer Password Strength = 59.1");
																						DeezerPasswordStrength = "Deezer Password Strength is: 59.1";
																						writePasswordStrengthResultToFile(DeezerPasswordStrength);
																					}
																				}else {
																					System.out.println("Deezer Password Strength = 57.0");
																					DeezerPasswordStrength = "Deezer Password Strength is: 57.0";
																					writePasswordStrengthResultToFile(DeezerPasswordStrength);
																				}
																			}else {
																				System.out.println("Deezer Password Strength = 52.7");
																				DeezerPasswordStrength = "Deezer Password Strength is: 52.7";
																				writePasswordStrengthResultToFile(DeezerPasswordStrength);
																			}
																		}else {
																			System.out.println("Deezer Password Strength = 51.7");
																			DeezerPasswordStrength = "Deezer Password Strength is: 51.7";
																			writePasswordStrengthResultToFile(DeezerPasswordStrength);
																		}
																	}else {
																		System.out.println("Deezer Password Strength = 49.1");
																		DeezerPasswordStrength = "Deezer Password Strength is: 49.1";
																		writePasswordStrengthResultToFile(DeezerPasswordStrength);
																	}
																}else {
																	System.out.println("Deezer Password Strength = 47.6");
																	DeezerPasswordStrength = "Deezer Password Strength is: 47.6";
																	writePasswordStrengthResultToFile(DeezerPasswordStrength);
																}
															}else {
																System.out.println("Deezer Password Strength = 47.3");
																DeezerPasswordStrength = "Deezer Password Strength is: 47.3";
																writePasswordStrengthResultToFile(DeezerPasswordStrength);
															}
														}else {
															System.out.println("Deezer Password Strength = 47.0");
															DeezerPasswordStrength = "Deezer Password Strength is: 47.0";
															writePasswordStrengthResultToFile(DeezerPasswordStrength);
														}
													}else {
														System.out.println("Deezer Password Strength = 45.6");
														DeezerPasswordStrength = "Deezer Password Strength is: 45.6";
														writePasswordStrengthResultToFile(DeezerPasswordStrength);
													}
												}else {
													System.out.println("Deezer Password Strength = 41.4");
													DeezerPasswordStrength = "Deezer Password Strength is: 41.4";
													writePasswordStrengthResultToFile(DeezerPasswordStrength);
												}
											}else {
												System.out.println("Deezer Password Strength = 39.5");
												DeezerPasswordStrength = "Deezer Password Strength is: 39.5";
												writePasswordStrengthResultToFile(DeezerPasswordStrength);
											}
										}else {
											System.out.println("Deezer Password Strength = 37.6");
											DeezerPasswordStrength = "Deezer Password Strength is: 37.6";
											writePasswordStrengthResultToFile(DeezerPasswordStrength);
										}
									}else {
										System.out.println("Deezer Password Strength = 36.8");
										DeezerPasswordStrength = "Deezer Password Strength is: 36.8";
										writePasswordStrengthResultToFile(DeezerPasswordStrength);
									}
								}else {	
									System.out.println("Deezer Password Strength = 35.7");
									DeezerPasswordStrength = "Deezer Password Strength is: 35.7";
									writePasswordStrengthResultToFile(DeezerPasswordStrength);
								}
							}else {
								System.out.println("Deezer Password Strength = 35.5");
								DeezerPasswordStrength = "Deezer Password Strength is: 35.5";
								writePasswordStrengthResultToFile(DeezerPasswordStrength);
							}
						}else {
							System.out.println("Deezer Password Strength = 34.2");
							DeezerPasswordStrength = "Deezer Password Strength is: 34.2";
							writePasswordStrengthResultToFile(DeezerPasswordStrength);
						}
					}else {
						System.out.println("Deezer Password Strength = 33.2");
						DeezerPasswordStrength = "Deezer Password Strength is: 33.2";
						writePasswordStrengthResultToFile(DeezerPasswordStrength);
					}
				}else {
					System.out.println("Deezer Password Strength = 31.0");
					DeezerPasswordStrength = "Deezer Password Strength is: 31.0";
					writePasswordStrengthResultToFile(DeezerPasswordStrength);
					}
			}else {
				System.out.println("Deezer Password Strength = 28.2");
				DeezerPasswordStrength = "Deezer Password Strength is: 28.2";
				writePasswordStrengthResultToFile(DeezerPasswordStrength);
			}			
		}else {
			System.out.println("Deezer Password Strength = 26.6");
			DeezerPasswordStrength = "Deezer Password Strength is: 26.6";
			writePasswordStrengthResultToFile(DeezerPasswordStrength);
			}		
	}else {
		System.out.println("Deezer Password Strength = 19.9");
		DeezerPasswordStrength = "Deezer Password Strength is: 19.9";
		writePasswordStrengthResultToFile(DeezerPasswordStrength);
		}			
}
}
