...
import com.strength.checker.framework.ShopifyScreens;


public class ShopifyPasswordStrengthChecker extends Base{

	String ShopifyUrl = "ShopifyUrl";
	String username;
	String email;
	int n = 3;
	String ShopifyPasswordStrength;
	...
	@Test
	public void ShopifyPwdStrengthChecker() throws Exception {
		propertiesFileLoad(ShopifyUrl);
		ShopifyUrl = lobConfigProp.getProperty("ShopifyUrl");
		 driver.get(ShopifyUrl);
		 driver.manage().window().maximize();
		 driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
         
		
		ShopifyScreens executor = new ShopifyScreens(driver);
																											...
																											if (executor.isElementPresent(executor.errorToast)) {
																												...
																												if (executor.isElementPresent(executor.errorToast)) {
																													...
																													if (executor.isElementPresent(executor.errorToast)) {
																														...
																														if (executor.isElementPresent(executor.errorToast)) {
																														ShopifyPasswordStrength = "Scenarios Not Sufficient. Need more Scenarios to determine Shopify Password Strength";			
																														writePasswordStrengthResultToFile(ShopifyPasswordStrength);
																													}else {
																														System.out.println("Shopify Password Strength = 79.1");
																														ShopifyPasswordStrength = "Shopify Password Strength is: 79.1";
																														writePasswordStrengthResultToFile(ShopifyPasswordStrength);
																													}
																												}else {
																													System.out.println("Shopify Password Strength = 71.4");
																													ShopifyPasswordStrength = "Shopify Password Strength is: 71.4";
																													writePasswordStrengthResultToFile(ShopifyPasswordStrength);	
																												}
																											}else {
																												System.out.println("Shopify Password Strength = 70.9");
																												ShopifyPasswordStrength = "Shopify Password Strength is: 70.9";
																												writePasswordStrengthResultToFile(ShopifyPasswordStrength);		
																											}
																										}else {
																											System.out.println("Shopify Password Strength = 68.4");
																											ShopifyPasswordStrength = "Shopify Password Strength is: 68.4";
																											writePasswordStrengthResultToFile(ShopifyPasswordStrength);			
																										}
																									}else {
																										System.out.println("Shopify Password Strength = 65.9");
																										ShopifyPasswordStrength = "Shopify Password Strength is: 65.9";
																										writePasswordStrengthResultToFile(ShopifyPasswordStrength);
																									}
																								}else {
																									System.out.println("Shopify Password Strength = 62.0");
																									ShopifyPasswordStrength = "Shopify Password Strength is: 62.0";
																									writePasswordStrengthResultToFile(ShopifyPasswordStrength);
																								}	
																							}else {
																								System.out.println("Shopify Password Strength = 61.3");
																								ShopifyPasswordStrength = "Shopify Password Strength is: 61.3";
																								writePasswordStrengthResultToFile(ShopifyPasswordStrength);
																							}
																						}else {
																							System.out.println("Shopify Password Strength = 59.5");
																							ShopifyPasswordStrength = "Shopify Password Strength is: 59.5";
																							writePasswordStrengthResultToFile(ShopifyPasswordStrength);
																						}
																					}else {
																						System.out.println("Shopify Password Strength = 59.1");
																						ShopifyPasswordStrength = "Shopify Password Strength is: 59.1";
																						writePasswordStrengthResultToFile(ShopifyPasswordStrength);
																					}
																				}else {
																					System.out.println("Shopify Password Strength = 57.0");
																					ShopifyPasswordStrength = "Shopify Password Strength is: 57.0";
																					writePasswordStrengthResultToFile(ShopifyPasswordStrength);
																				}
																			}else {
																				System.out.println("Shopify Password Strength = 52.7");
																				ShopifyPasswordStrength = "Shopify Password Strength is: 52.7";
																				writePasswordStrengthResultToFile(ShopifyPasswordStrength);
																			}
																		}else {
																			System.out.println("Shopify Password Strength = 51.7");
																			ShopifyPasswordStrength = "Shopify Password Strength is: 51.7";
																			writePasswordStrengthResultToFile(ShopifyPasswordStrength);
																		}
																	}else {
																		System.out.println("Shopify Password Strength = 49.1");
																		ShopifyPasswordStrength = "Shopify Password Strength is: 49.1";
																		writePasswordStrengthResultToFile(ShopifyPasswordStrength);
																	}
																}else {
																	System.out.println("Shopify Password Strength = 47.6");
																	ShopifyPasswordStrength = "Shopify Password Strength is: 47.6";
																	writePasswordStrengthResultToFile(ShopifyPasswordStrength);
																}
															}else {
																System.out.println("Shopify Password Strength = 47.3");
																ShopifyPasswordStrength = "Shopify Password Strength is: 47.3";
																writePasswordStrengthResultToFile(ShopifyPasswordStrength);
															}
														}else {
															System.out.println("Shopify Password Strength = 47.0");
															ShopifyPasswordStrength = "Shopify Password Strength is: 47.0";
															writePasswordStrengthResultToFile(ShopifyPasswordStrength);
														}
													}else {
														System.out.println("Shopify Password Strength = 45.6");
														ShopifyPasswordStrength = "Shopify Password Strength is: 45.6";
														writePasswordStrengthResultToFile(ShopifyPasswordStrength);
													}
												}else {
													System.out.println("Shopify Password Strength = 41.4");
													ShopifyPasswordStrength = "Shopify Password Strength is: 41.4";
													writePasswordStrengthResultToFile(ShopifyPasswordStrength);
												}
											}else {
												System.out.println("Shopify Password Strength = 39.5");
												ShopifyPasswordStrength = "Shopify Password Strength is: 39.5";
												writePasswordStrengthResultToFile(ShopifyPasswordStrength);
											}
										}else {
											System.out.println("Shopify Password Strength = 37.6");
											ShopifyPasswordStrength = "Shopify Password Strength is: 37.6";
											writePasswordStrengthResultToFile(ShopifyPasswordStrength);
										}
									}else {
										System.out.println("Shopify Password Strength = 36.8");
										ShopifyPasswordStrength = "Shopify Password Strength is: 36.8";
										writePasswordStrengthResultToFile(ShopifyPasswordStrength);
									}
								}else {	
									System.out.println("Shopify Password Strength = 35.7");
									ShopifyPasswordStrength = "Shopify Password Strength is: 35.7";
									writePasswordStrengthResultToFile(ShopifyPasswordStrength);
								}
							}else {
								System.out.println("Shopify Password Strength = 35.5");
								ShopifyPasswordStrength = "Shopify Password Strength is: 35.5";
								writePasswordStrengthResultToFile(ShopifyPasswordStrength);
							}
						}else {
							System.out.println("Shopify Password Strength = 34.2");
							ShopifyPasswordStrength = "Shopify Password Strength is: 34.2";
							writePasswordStrengthResultToFile(ShopifyPasswordStrength);
						}
					}else {
						System.out.println("Shopify Password Strength = 33.2");
						ShopifyPasswordStrength = "Shopify Password Strength is: 33.2";
						writePasswordStrengthResultToFile(ShopifyPasswordStrength);
					}
				}else {
					System.out.println("Shopify Password Strength = 31.0");
					ShopifyPasswordStrength = "Shopify Password Strength is: 31.0";
					writePasswordStrengthResultToFile(ShopifyPasswordStrength);
					}
			}else {
				System.out.println("Shopify Password Strength = 28.2");
				ShopifyPasswordStrength = "Shopify Password Strength is: 28.2";
				writePasswordStrengthResultToFile(ShopifyPasswordStrength);
			}			
		}else {
			System.out.println("Shopify Password Strength = 26.6");
			ShopifyPasswordStrength = "Shopify Password Strength is: 26.6";
			writePasswordStrengthResultToFile(ShopifyPasswordStrength);
			}		
	}else {
		System.out.println("Shopify Password Strength = 19.9");
		ShopifyPasswordStrength = "Shopify Password Strength is: 19.9";
		writePasswordStrengthResultToFile(ShopifyPasswordStrength);
		}			
}
}
