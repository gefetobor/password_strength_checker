...
import com.strength.checker.framework.AllrecepiesScreens;


public class AllrecepiesPasswordStrengthChecker extends Base{

	String AllrecepiesUrl = "AllrecepiesUrl";
	String username;
	String email;
	int n = 3;
	String AllrecepiesPasswordStrength;
	...
	@Test
	public void AllrecepiesPwdStrengthChecker() throws Exception {
		propertiesFileLoad(AllrecepiesUrl);
		AllrecepiesUrl = lobConfigProp.getProperty("AllrecepiesUrl");
		 driver.get(AllrecepiesUrl);
		 driver.manage().window().maximize();
		 driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
         
		
		AllrecepiesScreens executor = new AllrecepiesScreens(driver);
																															...
																															if (executor.isElementPresent(executor.errorToast)) {
																																...
																																if (executor.isElementPresent(executor.errorToast)) {
																																	...
																																	if (executor.isElementPresent(executor.errorToast)) {
																																		...
																																		if (executor.isElementPresent(executor.errorToast)) {
																																		AllrecepiesPasswordStrength = "Scenarios Not Sufficient. Need more Scenarios to determine Allrecepies Password Strength";			
																																		writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
																																			}else {
																																		System.out.println("Allrecepies Password Strength = 79.1");
																																		AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 79.1";
																																		writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
																																	}
																																}else {
																																	System.out.println("Allrecepies Password Strength = 71.4");
																																	AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 71.4";
																																	writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
																																}
																															}else {
																																System.out.println("Allrecepies Password Strength = 70.9");
																																AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 70.9";
																																writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
																															}
																														}else {
																															System.out.println("Allrecepies Password Strength = 68.4");
																															AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 68.4";
																															writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
																														}
																													}else {
																														System.out.println("Allrecepies Password Strength = 65.9");
																														AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 65.9";
																														writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
																													}
																												}else {
																													System.out.println("Allrecepies Password Strength = 65.5");
																													AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 65.5";
																													writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);	
																												}
																											}else {
																												System.out.println("Allrecepies Password Strength = 62.0");
																												AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 62.0";
																												writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);		
																											}
																										}else {
																											System.out.println("Allrecepies Password Strength = 61.3");
																											AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 61.3";
																											writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);			
																										}
																									}else {
																										System.out.println("Allrecepies Password Strength = 59.5");
																										AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 59.5";
																										writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
																									}
																								}else {
																									System.out.println("Allrecepies Password Strength = 59.1");
																									AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 59.1";
																									writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
																									
																								}	
																							}else {
																								System.out.println("Allrecepies Password Strength = 57.0");
																								AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 57.0";
																								writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
																							}
																						}else {
																							System.out.println("Allrecepies Password Strength = 54.6");
																							AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 54.6";
																							writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
																						}
																					}else {
																						System.out.println("Allrecepies Password Strength = 52.7");
																						AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 52.7";
																						writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
																					}
																				}else {
																					System.out.println("Allrecepies Password Strength = 51.7");
																					AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 51.7";
																					writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
																				}
																			}else {
																				System.out.println("Allrecepies Password Strength = 49.1");
																				AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 49.1";
																				writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
																			}
																		}else {
																			System.out.println("Allrecepies Password Strength = 47.6");
																			AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 47.6";
																			writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
																		}
																	}else {
																		System.out.println("Allrecepies Password Strength = 47.3");
																		AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 47.3";
																		writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
																	}
																}else {
																	System.out.println("Allrecepies Password Strength = 47.0");
																	AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 47.0";
																	writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
																}
															}else {
																System.out.println("Allrecepies Password Strength = 45.6");
																AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 45.6";
																writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
															}
														}else {
															System.out.println("Allrecepies Password Strength = 43.7");
															AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 43.7";
															writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
														}
													}else {
														System.out.println("Allrecepies Password Strength = 41.4");
														AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 41.4";
														writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
													}
												}else {
													System.out.println("Allrecepies Password Strength = 39.5");
													AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 39.5";
													writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
												}
											}else {
												System.out.println("Allrecepies Password Strength = 37.6");
												AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 37.6";
												writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
											}
										}else {
											System.out.println("Allrecepies Password Strength = 36.8");
											AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 36.8";
											writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
										}
									}else {
										System.out.println("Allrecepies Password Strength = 35.7");
										AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 35.7";
										writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
									}
								}else {	
									System.out.println("Allrecepies Password Strength = 35.5");
									AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 35.5";
									writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
								}
							}else {
								System.out.println("Allrecepies Password Strength = 34.2");
								AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 34.2";
								writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
							}
						}else {
							System.out.println("Allrecepies Password Strength = 33.2");
							AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 33.2";
							writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
						}
					}else {
						System.out.println("Allrecepies Password Strength = 32.8");
						AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 32.8";
						writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
					}
				}else {
					System.out.println("Allrecepies Password Strength = 31.0");
					AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 31.0";
					writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
					}
			}else {
				System.out.println("Allrecepies Password Strength = 28.2");
				AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 28.2";
				writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
			}			
		}else {
			System.out.println("Allrecepies Password Strength = 26.6");
			AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 26.6";
			writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
			}		
	}else {
		System.out.println("Allrecepies Password Strength = 19.9");
		AllrecepiesPasswordStrength = "Allrecepies Password Strength is: 19.9";
		writePasswordStrengthResultToFile(AllrecepiesPasswordStrength); writePasswordStrengthResultToFile("Account created on Allrecepies is : " + email);
		}			
}
}
