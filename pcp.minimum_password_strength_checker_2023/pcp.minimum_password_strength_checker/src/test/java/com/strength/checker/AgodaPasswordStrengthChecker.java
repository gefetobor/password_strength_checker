...
import com.strength.checker.framework.AgodaScreens;


public class AgodaPasswordStrengthChecker extends Base{

	String AgodaUrl = "AgodaUrl";
	String username;
	String email;
	String dob = "26/04/1992";
	int n = 3;
	String AgodaPasswordStrength;
	...
	@Test
	public void AgodaPwdStrengthChecker() throws Exception {
		propertiesFileLoad(AgodaUrl);
		AgodaUrl = lobConfigProp.getProperty("AgodaUrl");
		...
		AgodaScreens executor = new AgodaScreens(driver);
																															...
																															if (executor.isElementPresent(executor.errorToast)) {
																																...
																																if (executor.isElementPresent(executor.errorToast)) {
																																	...
																																	if (executor.isElementPresent(executor.errorToast)) {
																																		...
																																		if (executor.isElementPresent(executor.errorToast)) {
																																		AgodaPasswordStrength = "Scenarios Not Sufficient. Need more Scenarios to determine Agoda Password Strength";			
																																		writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
																																			}else {
																																		System.out.println("Agoda Password Strength = 79.1");
																																		AgodaPasswordStrength = "Agoda Password Strength is: 79.1";
																																		writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
																																	}
																																}else {
																																	System.out.println("Agoda Password Strength = 71.4");
																																	AgodaPasswordStrength = "Agoda Password Strength is: 71.4";
																																	writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
																																}
																															}else {
																																System.out.println("Agoda Password Strength = 70.9");
																																AgodaPasswordStrength = "Agoda Password Strength is: 70.9";
																																writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
																															}
																														}else {
																															System.out.println("Agoda Password Strength = 68.4");
																															AgodaPasswordStrength = "Agoda Password Strength is: 68.4";
																															writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
																														}
																													}else {
																														System.out.println("Agoda Password Strength = 65.9");
																														AgodaPasswordStrength = "Agoda Password Strength is: 65.9";
																														writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
																													}
																												}else {
																													System.out.println("Agoda Password Strength = 65.5");
																													AgodaPasswordStrength = "Agoda Password Strength is: 65.5";
																													writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);	
																												}
																											}else {
																												System.out.println("Agoda Password Strength = 62.0");
																												AgodaPasswordStrength = "Agoda Password Strength is: 62.0";
																												writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);		
																											}
																										}else {
																											System.out.println("Agoda Password Strength = 61.3");
																											AgodaPasswordStrength = "Agoda Password Strength is: 61.3";
																											writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);			
																										}
																									}else {
																										System.out.println("Agoda Password Strength = 59.5");
																										AgodaPasswordStrength = "Agoda Password Strength is: 59.5";
																										writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
																									}
																								}else {
																									System.out.println("Agoda Password Strength = 59.1");
																									AgodaPasswordStrength = "Agoda Password Strength is: 59.1";
																									writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
																									
																								}	
																							}else {
																								System.out.println("Agoda Password Strength = 57.0");
																								AgodaPasswordStrength = "Agoda Password Strength is: 57.0";
																								writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
																							}
																						}else {
																							System.out.println("Agoda Password Strength = 54.6");
																							AgodaPasswordStrength = "Agoda Password Strength is: 54.6";
																							writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
																						}
																					}else {
																						System.out.println("Agoda Password Strength = 52.7");
																						AgodaPasswordStrength = "Agoda Password Strength is: 52.7";
																						writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
																					}
																				}else {
																					System.out.println("Agoda Password Strength = 51.7");
																					AgodaPasswordStrength = "Agoda Password Strength is: 51.7";
																					writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
																				}
																			}else {
																				System.out.println("Agoda Password Strength = 49.1");
																				AgodaPasswordStrength = "Agoda Password Strength is: 49.1";
																				writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
																			}
																		}else {
																			System.out.println("Agoda Password Strength = 47.6");
																			AgodaPasswordStrength = "Agoda Password Strength is: 47.6";
																			writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
																		}
																	}else {
																		System.out.println("Agoda Password Strength = 47.3");
																		AgodaPasswordStrength = "Agoda Password Strength is: 47.3";
																		writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
																	}
																}else {
																	System.out.println("Agoda Password Strength = 47.0");
																	AgodaPasswordStrength = "Agoda Password Strength is: 47.0";
																	writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
																}
															}else {
																System.out.println("Agoda Password Strength = 45.6");
																AgodaPasswordStrength = "Agoda Password Strength is: 45.6";
																writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
															}
														}else {
															System.out.println("Agoda Password Strength = 43.7");
															AgodaPasswordStrength = "Agoda Password Strength is: 43.7";
															writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
														}
													}else {
														System.out.println("Agoda Password Strength = 41.4");
														AgodaPasswordStrength = "Agoda Password Strength is: 41.4";
														writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
													}
												}else {
													System.out.println("Agoda Password Strength = 39.5");
													AgodaPasswordStrength = "Agoda Password Strength is: 39.5";
													writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
												}
											}else {
												System.out.println("Agoda Password Strength = 37.6");
												AgodaPasswordStrength = "Agoda Password Strength is: 37.6";
												writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
											}
										}else {
											System.out.println("Agoda Password Strength = 36.8");
											AgodaPasswordStrength = "Agoda Password Strength is: 36.8";
											writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
										}
									}else {
										System.out.println("Agoda Password Strength = 35.7");
										AgodaPasswordStrength = "Agoda Password Strength is: 35.7";
										writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
									}
								}else {	
									System.out.println("Agoda Password Strength = 35.5");
									AgodaPasswordStrength = "Agoda Password Strength is: 35.5";
									writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
								}
							}else {
								System.out.println("Agoda Password Strength = 34.2");
								AgodaPasswordStrength = "Agoda Password Strength is: 34.2";
								writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
							}
						}else {
							System.out.println("Agoda Password Strength = 33.2");
							AgodaPasswordStrength = "Agoda Password Strength is: 33.2";
							writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
						}
					}else {
						System.out.println("Agoda Password Strength = 32.8");
						AgodaPasswordStrength = "Agoda Password Strength is: 32.8";
						writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
					}
				}else {
					System.out.println("Agoda Password Strength = 31.0");
					AgodaPasswordStrength = "Agoda Password Strength is: 31.0";
					writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
					}
			}else {
				System.out.println("Agoda Password Strength = 28.2");
				AgodaPasswordStrength = "Agoda Password Strength is: 28.2";
				writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
			}			
		}else {
			System.out.println("Agoda Password Strength = 26.6");
			AgodaPasswordStrength = "Agoda Password Strength is: 26.6";
			writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
			}		
	}else {
		System.out.println("Agoda Password Strength = 19.9");
		AgodaPasswordStrength = "Agoda Password Strength is: 19.9";
		writePasswordStrengthResultToFile(AgodaPasswordStrength); writePasswordStrengthResultToFile("Account created on Agoda is : " + email);
		}			
}
}
