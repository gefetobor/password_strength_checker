...
import com.strength.checker.framework.SciencedirectScreens;


public class SciencedirectPasswordStrengthChecker extends Base{

	String SciencedirectUrl = "SciencedirectUrl";
	String username;
	String email;
	int n = 3;
	String SciencedirectPasswordStrength;
	...
	@Test
	public void SciencedirectPwdStrengthChecker() throws Exception {
		propertiesFileLoad(SciencedirectUrl);
		SciencedirectUrl = lobConfigProp.getProperty("SciencedirectUrl");
		 driver.get(SciencedirectUrl);
		 driver.manage().window().maximize();
		 driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
         
		
		SciencedirectScreens executor = new SciencedirectScreens(driver);
		...
		if (executor.isElementPresent(executor.register)) {
			...
			WebElement pwd = driver.findElement(By.xpath("//input[@id='bdd-password']"));
																															...
																															if (executor.isElementPresent(executor.register)) {
																																...
																																if (executor.isElementPresent(executor.register)) {
																																	...
																																	if (executor.isElementPresent(executor.register)) {
																																		...
																																		if (executor.isElementPresent(executor.register)) {
																																		SciencedirectPasswordStrength = "Scenarios Not Sufficient. Need more Scenarios to determine Sciencedirect Password Strength";			
																																		writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
																																			}else {
																																		System.out.println("Sciencedirect Password Strength = 79.1");
																																		SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 79.1";
																																		writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
																																	}
																																}else {
																																	System.out.println("Sciencedirect Password Strength = 71.4");
																																	SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 71.4";
																																	writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
																																}
																															}else {
																																System.out.println("Sciencedirect Password Strength = 70.9");
																																SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 70.9";
																																writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
																															}
																														}else {
																															System.out.println("Sciencedirect Password Strength = 68.4");
																															SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 68.4";
																															writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
																														}
																													}else {
																														System.out.println("Sciencedirect Password Strength = 65.9");
																														SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 65.9";
																														writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
																													}
																												}else {
																													System.out.println("Sciencedirect Password Strength = 65.5");
																													SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 65.5";
																													writePasswordStrengthResultToFile(SciencedirectPasswordStrength);	
																												}
																											}else {
																												System.out.println("Sciencedirect Password Strength = 62.0");
																												SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 62.0";
																												writePasswordStrengthResultToFile(SciencedirectPasswordStrength);		
																											}
																										}else {
																											System.out.println("Sciencedirect Password Strength = 61.3");
																											SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 61.3";
																											writePasswordStrengthResultToFile(SciencedirectPasswordStrength);			
																										}
																									}else {
																										System.out.println("Sciencedirect Password Strength = 59.5");
																										SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 59.5";
																										writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
																									}
																								}else {
																									System.out.println("Sciencedirect Password Strength = 59.1");
																									SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 59.1";
																									writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
																								}	
																							}else {
																								System.out.println("Sciencedirect Password Strength = 57.0");
																								SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 57.0";
																								writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
																							}
																						}else {
																							System.out.println("Sciencedirect Password Strength = 54.6");
																							SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 54.6";
																							writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
																						}
																					}else {
																						System.out.println("Sciencedirect Password Strength = 52.7");
																						SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 52.7";
																						writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
																					}
																				}else {
																					System.out.println("Sciencedirect Password Strength = 51.7");
																					SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 51.7";
																					writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
																				}
																			}else {
																				System.out.println("Sciencedirect Password Strength = 49.1");
																				SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 49.1";
																				writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
																			}
																		}else {
																			System.out.println("Sciencedirect Password Strength = 47.6");
																			SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 47.6";
																			writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
																		}
																	}else {
																		System.out.println("Sciencedirect Password Strength = 47.3");
																		SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 47.3";
																		writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
																	}
																}else {
																	System.out.println("Sciencedirect Password Strength = 47.0");
																	SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 47.0";
																	writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
																}
															}else {
																System.out.println("Sciencedirect Password Strength = 45.6");
																SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 45.6";
																writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
															}
														}else {
															System.out.println("Sciencedirect Password Strength = 43.7");
															SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 43.7";
															writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
														}
													}else {
														System.out.println("Sciencedirect Password Strength = 41.4");
														SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 41.4";
														writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
													}
												}else {
													System.out.println("Sciencedirect Password Strength = 39.5");
													SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 39.5";
													writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
												}
											}else {
												System.out.println("Sciencedirect Password Strength = 37.6");
												SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 37.6";
												writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
											}
										}else {
											System.out.println("Sciencedirect Password Strength = 36.8");
											SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 36.8";
											writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
										}
									}else {
										System.out.println("Sciencedirect Password Strength = 35.7");
										SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 35.7";
										writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
									}
								}else {	
									System.out.println("Sciencedirect Password Strength = 35.5");
									SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 35.5";
									writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
								}
							}else {
								System.out.println("Sciencedirect Password Strength = 34.2");
								SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 34.2";
								writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
							}
						}else {
							System.out.println("Sciencedirect Password Strength = 33.2");
							SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 33.2";
							writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
						}
					}else {
						System.out.println("Sciencedirect Password Strength = 32.8");
						SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 32.8";
						writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
					}
				}else {
					System.out.println("Sciencedirect Password Strength = 31.0");
					SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 31.0";
					writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
					}
			}else {
				System.out.println("Sciencedirect Password Strength = 28.2");
				SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 28.2";
				writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
			}			
		}else {
			System.out.println("Sciencedirect Password Strength = 26.6");
			SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 26.6";
			writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
			}		
	}else {
		System.out.println("Sciencedirect Password Strength = 19.9");
		SciencedirectPasswordStrength = "Sciencedirect Password Strength is: 19.9";
		writePasswordStrengthResultToFile(SciencedirectPasswordStrength);
		}			
}
}
