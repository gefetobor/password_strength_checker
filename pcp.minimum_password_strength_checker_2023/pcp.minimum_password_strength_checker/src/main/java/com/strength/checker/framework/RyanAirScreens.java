...
public class RyanAirScreens extends GenericMethods {
	
	
	public RyanAirScreens(WebDriver driver) {
		super(driver);
		//this.driver = driver;
	}
    ...
    public By errorToast = By.xpath("//*[text()='Please check the requirements on your right']");
