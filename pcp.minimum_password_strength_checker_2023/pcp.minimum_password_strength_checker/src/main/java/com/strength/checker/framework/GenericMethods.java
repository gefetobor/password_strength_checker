...
public class GenericMethods {
    ...
    public Boolean isElementDisplayed(By targetElement) throws InterruptedException {
        Boolean isPresent = ((WebElement) driver.findElements(targetElement)).isDisplayed();
        return isPresent;
    }
	...
	// class variable
	 final String lexicon = "ABCDEFGHIJKLMNOP";
	 ...
	 public String randomName() {
		    ...
		    private static String[] firstNames = {"sun", "esther", "anthony", "fope", "stoke", "knight", "zino", "petre", "anabella", "bazel", "paul", "banter", "willis", "sunday"};
		    private static String[] lastNames = {"petre", "dame", "bazel", "paul", "banter", "willis", "moon"};
